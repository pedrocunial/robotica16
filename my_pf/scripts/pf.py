...
from tf.transformations import (euler_from_quaternion,
                                rotation_matrix, quaternion_from_matrix)
...
class Particle(object):
    ...
    """
        Represents a hypothesis (particle) of the robot's pose
        consisting of x,y and theta (yaw)
        Attributes:
    ...
    def as_pose(self):
        ...
        particle to a geometry_msgs/Pose message """
